    ...
    return (
        <div className="space-y-8 font-mono">
            <div className="bg-white/10 backdrop-blur-xl p-10 rounded-[2.5rem] border border-white/20 shadow-2xl min-h-[450px] flex flex-col">
                <div className="mb-8">
                    <span className="text-brand font-bold text-[10px] uppercase tracking-[0.3em] opacity-60">
                ...
                <div className="flex justify-between mt-12 pt-8 border-t border-slate-100/50">
                    ...
                    {currentIdx === questions.length - 1 ? (
                        <button
                            ...
                            className="px-10 py-4 bg-brand text-white text-[10px] font-bold uppercase tracking-[0.2em] rounded-2xl hover:bg-slate-900 transition-all disabled:opacity-20 shadow-xl shadow-brand/10 flex items-center gap-2"
                        >
                        ...
                        <button
                            onClick={() => setCurrentIdx(prev => prev + 1)}
                            className="flex items-center gap-2 px-10 py-4 bg-slate-900 text-white text-[10px] font-bold rounded-2xl uppercase tracking-[0.2em] transition hover:bg-brand shadow-lg shadow-black/5"
                        >
                ...
                {questions.map((_, idx) => (
                    <button
                        ...
                        className={`w-3 h-3 rounded-full transition-all duration-500 ${currentIdx === idx
                            ? 'bg-brand scale-150 shadow-lg shadow-brand/20'
