            ...
            <aside className="w-64 bg-white border-r border-slate-200 p-6 flex flex-col gap-8">
                ...
                <nav className="flex flex-col gap-2">
                    {[
                        ...
                        <Link
                            key={item.name}
                            href={item.href}
                            className="flex items-center gap-3 px-4 py-3 text-sm font-bold text-slate-600 hover:bg-slate-50 hover:text-blue-600 rounded-xl transition"
                        >
                            {item.icon} {item.name}
                        </Link>
                    ))}
                ...
                <div className="mt-auto">
                    <Link
                        ...
                        className="flex items-center gap-3 px-4 py-3 text-sm font-bold text-slate-400 hover:text-blue-600 hover:bg-slate-50 rounded-xl transition"
                    >
                        ← Back to Portal
                    </Link>
                </div>
